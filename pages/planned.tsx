...
export default function Planned({ userData, projectsTitleId, pageData }: { userData: typeUserData, projectsTitleId: typeProjectsTitleId[], pageData: typeTask[] }) {
  const titleIcon = () => {
    return (
      <svg
      className="fill-white w-[2.2vh] sm:w-[3vh] m-auto opacity-80 "
...
// ! I've tidied the lines, don't use automation from prettier to make tidier
  ...
  return (
    <>
      ...
      {/* Tinggal pasang logic kalo duedatenya gak null bakal di show */}
